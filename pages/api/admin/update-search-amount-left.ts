...
import { Input } from '@models/api/admin/updateSearchAmountLeft'
import { updateSearchAmountLeft } from '@utils/api/admin/updateSearchAmountLeft'
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  if (req.method === 'PUT') {
    try {
      ...
      const { success, response, error, message } = await updateSearchAmountLeft({
        ...requestBody,
